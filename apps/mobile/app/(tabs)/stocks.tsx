...
const columns = ["name", "category", "amount", "dealer", "storage"];

export default function StocksScreen() {
  const { selectStock, fetchInitialData, fetchPage, totalCount, stocks } =
    useStockStore();
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      />
      <Button type="primary" onPress={() => router.replace("/addStock")}>
        Stok Ekle
      </Button>
    </SafeAreaView>
  );
